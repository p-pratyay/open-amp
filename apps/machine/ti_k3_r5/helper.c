...
__attribute__((naked, section(".isr_vector"), target("arm"))) void vectors()
{
	asm volatile(
		...
		"LDR PC, =HwiP_undefined_handler \n"
		"LDR PC, =HwiP_svc_handler   \n"
		"LDR PC, =HwiP_prefetch_abort_handler \n"
		"LDR PC, =HwiP_data_abort_handler_ASM \n"
		"NOP                    \n"
		"LDR PC, =HwiP_irq_handler   \n"
		"LDR PC, =HwiP_fiq_handler   \n");
}
